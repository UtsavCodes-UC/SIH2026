...
| How good are the plans? | Against proven optima on 22 standard instances (100-199 customers) the route search is 2.9% above optimal after 10 s and 1.5% after 2 minutes, better than OR-Tools' 60 s solution (5.5%); the app's default QPSO pipeline averaged 10.2% above optimal (Finding 14). |
